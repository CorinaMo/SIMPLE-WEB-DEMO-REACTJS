export const ProfilePicture = ({ size }) => {
    return (
        <div className={`flex flex-col p-2 -mt-10 relative rounded-full self-center border-blue-50 border-2 border-opacity-70 bg-white bg-opacity-30`}>
            ...
            height={size}
                ...
                alt="profile-pic"
                className={`rounded-full border-gray-600 border-2 border-opacity-20 z-[2]`} />
        </div>
    )
};
