import { conicGradientReverse } from "../../styles";

export const ProfilePicture = () => {
    return (
        <div className="flex flex-col w-24 h-24 p-2 -mt-10 relative rounded-full self-center border-blue-50 border-2 border-opacity-70 bg-white bg-opacity-30">
        ...
        <div className="flex flex-col w-full h-full absolute left-0 top-0 rounded-full bg-gray-100 bg-opacity-10 shadow-inner blur-sm shadow-gray-100 self-center" />
            <img
                ...
                alt="profile-pic"
                className="rounded-full w-24 h-24 border-gray-600 border-2 border-opacity-20 z-[2]" />
        </div>
    )
};
