...
export const ProfileCard = () => {
    return (
        <div className="flex flex-col w-[84%] h-fit pb-10 pt-10 relative sm:w-8/12 md:w-1/3 bg-gray-100 border-blue-50 border-2 border-opacity-5 bg-opacity-10 rounded-lg backdrop-blur-md">
