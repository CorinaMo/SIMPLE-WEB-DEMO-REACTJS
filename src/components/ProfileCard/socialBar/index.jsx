...
export const SocialBar = () => {
    const linkStyle = 'flex flex-col w-10 h-10 p-2 bg-black border-black border-2 border-opacity-5 bg-opacity-20 rounded-full backdrop-filter drop-shadow-xl shadow-slate-200 backdrop-blur-sm place-center hover:bg-white hover:bg-opacity-40'
